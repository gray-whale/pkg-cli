import{_ as s,c as a,o as n,a3 as i}from"./chunks/framework.YJ5MLIJG.js";const E=JSON.parse('{"title":"目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"directory.md","filePath":"directory.md"}'),p={name:"directory.md"},e=i(`<h1 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h1><h2 id="源代码目录" tabindex="-1">源代码目录 <a class="header-anchor" href="#源代码目录" aria-label="Permalink to &quot;源代码目录&quot;">​</a></h2><p>基于 Pkg CLI 搭建的组件库的基本目录结构如下所示：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>project</span></span>
